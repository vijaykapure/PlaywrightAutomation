...
- Name: homepagetest.spec.js >> verify Laptops categories products
- Location: tests\homepagetest.spec.js:34:1
...
Call log:
  - waiting for locator('//button[contains(text(),\'Log in\')]')
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: kapurevijay6@gmail.com
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox [ref=e15]: Vijay@123
        - generic [ref=e17]:
...
```ts
  ...
  6  |         this.passwordInput = page.locator('[id="loginpassword"]');
  7  |         this.userlogin = page.locator("//button[contains(text(),'Log in')]");
  8  | 
  9  | 
  10 |     }
  11 | 
  12 |     async navigate() {
  13 | 
  14 |         await this.page.goto("https://www.demoblaze.com/index.html");
  15 | 
  16 |     }
  17 | 
